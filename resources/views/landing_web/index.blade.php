...
<div class="grid_1">
	<div class="container">
		...
		<ul id="flexiselDemo3">
			@foreach($successCouple as $key=>$value)
			<li>
				<div class="col_1"><a href="view_profile.html">
					<img src="{{asset('success_couple_profiles/'.$value->success_couple)}}" alt="" class="hover-animation image-zoom-in img-responsive"/ style="height: 200px;">
					<div class="layer m_1 hidden-link hover-animation delay1 fade-in">
						<div class="center-middle">About Him</div>
					</div>
					<h3><span class="m_3">{{$value->bride_name}}</span><br>28, Christian, Australia<br>Corporate</h3></a>
				</div>
			</li>
			@endforeach


			@foreach($riviewSucessCouple as $key=>$value)
			<li>
				<div class="col_1"><a href="view_profile.html">
					<img src="{{asset('success_couple_profiles/'.$value->image_profile)}}" alt="" class="hover-animation image-zoom-in img-responsive"/ style="height: 200px;">
					<div class="layer m_1 hidden-link hover-animation delay1 fade-in">
						<div class="center-middle"><a href="{{route('review')}}">click</a></div>
					</div>
					<h3><span class="m_3">{{$value->bride_name}} && {{$value->groom_name}}</span><br>28, Christian, Australia<br>Corporate</h3></a>
				</div>
			</li>
			@endforeach
			...
			<div class="col-md-12 col-md-offset-0">
				<ul class="timeline animate-box animate_image">
					<li class="animate-box">
						...
						<div class="timeline-panel">
							<div class="timeline-heading">
								<h3 class="timeline-title" style="color:#8B0000">First We Meet</h3>
								<span class="date" style="color:#8B0000">December 25, 2015</span>
							</div>
							<div class="timeline-body">
								<p style="color:#8B0000">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
							</div>
						</div>
					</li>
					<li class="timeline-inverted animate-box animate_image">
						...
						<div class="timeline-panel">
							<div class="timeline-heading">
								<h3 class="timeline-title" style="color:#8B0000">First Date</h3>
								<span class="date" style="color:#8B0000">December 28, 2015</span>
							</div>
							<div class="timeline-body">
								<p style="color:#8B0000">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
							</div>
					...
					<li class="animate-box">
						...
						<div class="timeline-panel">
							<div class="timeline-heading">
								<h3 class="timeline-title" style="color:#8B0000">In A Relationship</h3>
								<span class="date" style="color:#8B0000">January 1, 2016</span>
							</div>
							<div class="timeline-body">
								<p style="color:#8B0000">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
							</div>
