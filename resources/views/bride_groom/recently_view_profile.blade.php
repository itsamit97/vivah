...
<div class="grid_3">
  <div class="container">
   ...
   <div class="col-md-3 col_5">
   	 ...
   	 <img src="{{asset('web_assets/images/s1.jpg')}}" class="img-responsive" alt=""/>
       ...
       <div class="col_4">
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
	          ...
	          <div class="clearfix"> </div>
	           ...
	           <!-- ------------------star foreach---------------------------- -->
	          @foreach($recentlyViewProfileData as $key=>$value)
	       	   <div class="jobs-item with-thumb">
	              	<div class="thumb_top">
					    <div class="thumb"><a href="view_profile.html"><img src="{{asset('profiles/'.$value->profile)}}" class="img-responsive" alt=""/></a>
					    </div>
						    <div class="jobs_right">
									<h6 class="title"><a href="view_profile.html">{{$value->first_name}} - {{$value->last_name}}</a></h6>
									<ul class="top-btns">
									...
									<ul class="login_details1">
									  <li>{{$value->visitor_user_id}}</li>
									</ul>
									<p class="description">Age:{{$value->age}} <span class="m_1">Reliogion:</span> | <span class="m_1">Cast</span> : {{$value->cast}} | <span class="m_1">Occupation</span> :Occupation<br><a href="{{route('bride_groom_details',['id'=>$value->visitor_user_id,'role'=>$value->visitor_role])}}" class="read-more"> full profile</a></p>
							</div>
							<div class="clearfix"> </div>
					</div>
