...
<div class="grid_3">
  <div class="container">
   ...
   <div class="profile">
   	 ...
   	 @foreach($brideGroomDetails as $key=>$value)
   	 	@if($value->role == 2)
		   	 		<h2>Groom Details :</h2>
		   	 	@else	
		   	 		<h2>Bride Details :</h2>
		...
		<div class="col_4">
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			   <ul id="myTab" class="nav nav-tabs nav-tabs1" role="tablist">
				  ...
				  <li role="presentation"><a href="{{route('image_gallery',['id'=>$value->id,'role'=>$value->role])}}" class="read-more"> Image Gallery</a></li>
			   </ul>
