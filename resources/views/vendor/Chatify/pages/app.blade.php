...
<div class="messenger">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($type == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> People Friends</a>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <!--  <img src="{{asset('web_assets/images/bride_groom/3.jpg')}}" class="img-responsive" style="height:40px; width:40px; border-radius:30px;" alt=""/> -->
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Please select a chat && search friend &&  start messaging</span></p>
            </div>
            {{-- Typing indicator --}}
