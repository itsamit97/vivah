...
<!-- toster msg cdn-->
	<!-- toseter alert msg  cdn -->
		<!-- !-- CSS --> 
	<link href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.0/css/toastr.css" rel="stylesheet" />

	<!-- JS -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.0/js/toastr.js"></script>
<!-- end toseter alert msg  cdn -->
...
<!-- =====================  Navigation Start ================= -->
 <div class="navbar navbar-inverse-blue navbar">
    <!--<div class="navbar navbar-inverse-blue navbar-fixed-top">-->
      <div class="navbar-inner navbar-fixed-top" class="banner" id="myHeader">
        <div class="container">
				    ...
				    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
				        <ul class="nav navbar-nav nav_1">
				            ...
				            <li oncli id="my_profile()"><a href="{{route('self_profile')}}" id="my_profile">My Profile</a></li>
				              <li oncli id="my_profile()"><a href="{{route('testing_profile')}}" id="my_profile">New Profile</a></li>
				            <li class="last"><a href="{{route('contact')}}">Contacts</a></li>
				            <li class="last"><a href="{{route('intro')}}">Intro</a></li>
				            <li class="last"><a href="{{route('review')}}">Review</a></li>
